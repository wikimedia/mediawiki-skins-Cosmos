...
class CosmosTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		if ($this->getMsg('cosmos-customsidebar')
			...
			->text() !== '') {
			$html .= Html::rawElement('div', ['id' => 'cosmos-sidebar'], Html::openElement('div', ['id' => 'cosmos-custom-sidebar', 'class' => 'sidebar cosmos-sidebar']) . Html::rawElement('div', ['class' => 'sidebar-inner'], $this->getMsg('cosmos-customsidebar')
				->parse()));
		}
		$html .= Html::closeElement('div');
		$html .= Html::closeElement('div');
