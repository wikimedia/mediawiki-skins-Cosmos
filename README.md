...
It is recommended to install the Master branch for the latest MediaWiki release (currently 1.35) or the appropriate MediaWiki version branches for earlier MediaWiki versions. Old branches are no longer maintained.
